<button command="show-modal" commandfor="delete-project-section-{{$section->id}}"
    class="items-center space-x-1 text-red-700 "><i class="fa-solid fa-trash-can"></i> <span>Delete</span> </button>
</button>
<el-dialog>
    <dialog id="delete-project-section-{{$section->id}}" aria-labelledby="delete-section"
        ...
        <div tabindex="0"
            ...
            <el-dialog-panel
                ...
                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 id="dialog-title" class="text-base font-semibold text-gray-900">Deleting Project Section:
                                {{$section->title}}</h3>
                            <div class="mt-2">
                ...
                <div class="px-4 py-3 bg-gray-50 sm:flex sm:flex-row-reverse sm:px-6">
                    ...
                    <form action="{{route('project-sections.destroy', $section->id)}}" method="POST">
                        @csrf
                        @method("DELETE")
                        <input type="hidden" name="projectSectionId" value="{{$section->id}}">
                        <button type="submit"
                    ...
                    <button type="button" command="close" commandfor="delete-project-section-{{$section->id}}"
