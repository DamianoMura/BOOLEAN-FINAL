                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <div class="relative text-center group">
                            <i class="absolute text-2xl transition duration-200 ease-in-out opacity-100 -top-1 fa-solid fa-address-book group-hover:opacity-0"></i>
                            <i class="absolute text-2xl transition duration-200 ease-in-out opacity-0 -top-1 fa-regular fa-address-book group-hover:opacity-100"></i>
