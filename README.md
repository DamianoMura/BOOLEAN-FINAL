...
- Se avete scelto i **videogiochi**, potreste avere la tabella delle _console_ su cui è disponibile un gioco (PS5, Xbox, Switch).
- Se avete scelto i **film**, potreste collegarli ai _generi cinematografici_ (Azione, Commedia, Horror).
